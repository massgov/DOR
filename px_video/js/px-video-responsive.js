/* Universal Video Player (https://source.ind.ie/project/video-player/tree/master)
A fork based on the PayPal HTML5 Accessible Video Player. Made responsive. */
...
function InitPxVideo(options) {
	...
	function fullScreenStyles() {
		if (document.fullscreen || document.mozFullScreen || document.webkitIsFullScreen || document.msFullscreenElement) {
			...
			// ORIG: obj.container.setAttribute("style", "width: 100%; height: 100%;");
			obj.container.setAttribute("style", "width: 100%; height: auto;");
			...
			// ORIG: obj.movie.setAttribute('height', '100%');
			obj.movie.setAttribute('height', 'auto');
		} else {
	...
	obj.progressBar.name = "progressb";
	...
	obj.progressBar.addEventListener('click', function (e) {
		// EDIT: Changed calculation to calculate the X position of an element, not from overall pageX (x position of mouse on whole page).
		// obj.pos = (e.pageX - this.offsetLeft) / this.offsetWidth;
		
   		var relX = e.pageX - $(this).offset().left;		
		obj.pos = (relX) / this.offsetWidth;
...
/* EDIT: THIS WAS THE ORIGINAL STUFF IN THE RESPONSIVE PLAYER, IT DID NOT WORK FOR CAPTIONS ON IE
	...
	// EDIT: THIS IS THE STUFF IMPORTED FROM paypal.github.io/accessible-html5-video-player/ TO MAKE THE CAPTIONS WORK IN IE.
	// If no caption file exists, hide container for caption text
	if (!obj.captionExists) {
		obj.captionsContainer.className = "px-video-captions hide";
	} else {
